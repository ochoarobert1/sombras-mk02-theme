...
<main class="container-fluid p-0" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
    <div class="row no-gutters">
        <?php $page_info = get_page_by_title('archive-eventos', 'ARRAY_A', 'PAGE'); ?>
            ...
            <div class="row">
                <section class="events-archive-current col-12">
                    ...
                    <div class="events-archive-current-container">
                        ...
                        <?php $args = array('post_type' => 'eventos', 'posts_per_page' => -1, 'order' => 'DESC', 'orderby' => 'date', 'post__in' => $array_posts); ?>
                        <?php query_posts($args); ?>
                        <?php if (have_posts()) : ?>
                        <ul class="list-unstyled">
                            <?php while (have_posts()) : the_post(); ?>
                            <li class="media event-media">
                                <img class="mr-3" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" alt="<?php _e('Ver información del evento', 'sombras')?>" />
