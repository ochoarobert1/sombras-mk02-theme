...
function sombras_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/sombras-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('init', 'sombras_load_css');
